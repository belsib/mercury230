...
class Mercury230Sensor : public Mercury230SensorBase, public sensor::Sensor {
 public:
...
#ifdef USE_TEXT_SENSOR
class Mercury230TextSensor : public Mercury230SensorBase, public text_sensor::TextSensor {
 public:
