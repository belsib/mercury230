...
class Mercury230Uart final : public uart::ESP8266UartComponent {
 public:
  Mercury230Uart(uart::ESP8266UartComponent const &uart)
      : uart_(uart), hw_(uart.*(&Mercury230Uart::hw_serial_)), sw_(uart.*(&Mercury230Uart::sw_serial_)) {}
...
#ifdef USE_ESP_IDF
class Mercury230Uart final : public uart::IDFUARTComponent {
 public:
  Mercury230Uart(uart::IDFUARTComponent &uart)
      : uart_(uart), iuart_num_(uart.*(&Mercury230Uart::uart_num_)), ilock_(uart.*(&Mercury230Uart::lock_)) {}
